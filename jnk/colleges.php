...
<body>
	...
	<table id="colleges" data-height="550" data-toggle="table" data-url="operations/showColleges.php" data-pagination="true" data-search="true" data-sort-name="Submitted" data-sort-order="asc" data-show-refresh="true" >
...
<div class="modal fade bs-example-modal-lg" id="courseModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
  <div class="modal-dialog modal-lg" role="document">
	<div class="modal-content" >
...
window.operateEvents = {
	'click .Email': function (e, value, row, index) {				
		window.open("/sendmail.php?collegename="+row.fakeName+"&collegeusrname="+row.UserId+"&Password="+encodeURIComponent(row.Password)+"&email="+row.PrincipalEmail,'_blank');		
	}
};
 </script>
