	...
	<body>
		...
		<div class="container" style="margin-top: 50px; margin-bottom: 20px;">
			...
			<?php
				...
				/* $query1='SELECT isReVerificationStarted FROM others';	
				...
				$query3='SELECT * FROM students_x WHERE studentUniqueId=?';
				$stmt3 = mysqli_prepare($con, $query3);
				mysqli_stmt_bind_param($stmt3, 'i', $studentUniqueId);
				mysqli_stmt_execute($stmt3);
				$result3 = mysqli_stmt_get_result($stmt3);
				$user_row_x = mysqli_fetch_array($result3, MYSQLI_ASSOC);	
				...
				if(/*$user_row['title'] == "HSC" || */$user_row['title'] == "Diploma"){
			...
			<div class="row setup-content step activeStepInfo frm" id="step-6">
				<?php
					include("./partials/forms/submitForm_Valid.php");
					mysqli_close ($con);
				?>
			</div> 
		...
		<script type="text/javascript" src="js/autosaveupdated.js"></script>
