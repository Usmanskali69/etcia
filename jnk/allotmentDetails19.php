...
<body>
	<div id="header" class="navbar navbar-default navbar-fixed-top">
		...
		<nav class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav pull-right">
				...
				<?php if ($user_row['yearOfCounselling'] == '2020-21' && $user_row['title'] == 'HSC' && $closed == 'Yes') { ?><a class="navbar-brand" href="examDetails.php" style="font-size:15px;"><b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Entrance Examinations</b> </a>
				<?php
				} ?>
				<!-- User Profile tab -->
				<!-- User Profile tab -->
	...
	<br><br>
	<?php if ($own_row['title'] == 'HSC') { ?><h5 align="center"><a href="resource/instructionManual19.pdf" target="_blank"><u>
		...
		<div class="container-fluid">
			<div class="col-sm-offset-1 col-sm-10" role="complementary">
					...
					<div class="well">
						<h6><b>
								<font size="3">Dear <?php echo $own_row['name']; ?> (<?php echo $user_row['studentUniqueId']; ?>), <br><br>
									&nbsp;&nbsp;&nbsp;&nbsp;Congratulations ! The allotted college <?php if ($own_row['title'] == 'Diploma') {
				...
				<?php if ($own_row['birthPlace'] == 'Yes') { ?>
					<div class="well">
						<h6><b>
								<font size="3">Congratulations, You are Provisionally admitted <?php if ($own_row['title'] == 'Diploma') {
																											echo "under lateral entry admission for the";
																										} ?> <?php echo $user_row['courseName']; ?> Branch of <?php echo $user_row['collegeName']; ?> college. Now, You can Download Allotment letter from your login. You are requested to join college with in due time and collect the Joining Report from College in the Institute letterhead and upload as early as possible.<?php if ($own_row['title'] == 'Diploma') {
																																																																																																												echo "Last date for admission and uploading of joining report is 14-08-2019 failing which your seat will be cancelled automatically.";
																																																																																																											} ?></font>
							</b></h6>
					</div>
				<?php
	...
	<form id="seatForm" class="form-horizontal" role="form" method="get" enctype="multipart/form-data">
						...
						<table class="table table-bordered f11">
							<?php if ($user_row['modeOfAdmission'] == 'Through Centralised counselling') { ?>
								...
								<tr>
									...
									<?php if ($own_row['applicationStatus'] == 'Seat Allocated' || $own_row['applicationStatus'] == 'Seat Allocated - RC') { ?><td align="left"><a data-toggle="modal" data-target="#choicesTable" style="cursor:pointer;"><?php echo $user_row['collegeName'] . '(' . $user_row['collegeUniqueId'] . ')'; ?></a></td><?php
																																																																																							} else { ?><td align="left"><?php echo $user_row['collegeName'] . '(' . $user_row['collegeUniqueId'] . ')'; ?></td><?php
																																																																																																																					} ?>
								...
								<tr>
									...
									<td align="left"> <?php if ($own_row['allotmentDate'] >= "2019-08-14 00:00:00") {
																$allotmentDates = "2019-08-14 00:00:00";
															}
															echo date('d-m-Y', strtotime($allotmentDates));
															?></td>
								</tr>
								<tr>
									<td align="left"><b>NBA Accreditated:</b></td>
									<td align="left"> <?php if ($user_row['isNBAAccredited'] != '') {
																echo $user_row['isNBAAccredited'];
															} else {
																echo '-NA-';
															} ?></td>
									<td align="left"><b>NAAC Accreditated:</b></td>
									<td align="left"><?php if ($user_row['isNAACAccreditated'] != '') {
								...
								<tr>
									...
									<td align="left"><?php if ($user_row['isNIRFAccreditated'] != '') {
						...
						<div class="panel-body table-responsive">
							<table class="table table-responsive table-bordered">
								...
								<tr>
									...
									<td width="30%" align="left"><?php if ($willingnessRow['others'] != '') {
				...
				<div class="container-fluid">
					<div class="col-sm-offset-1 col-sm-10" role="complementary">
						<div class="well">
							...
							<h6><b>
									<font size="3">2. If you are not at all interested to take admission in the PMSSS Admission 2020-21 then click button (not interested in PMSSS).<br>
										<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;NOTE: Once you clicked on (button not interested in PMSSS) button, you would not be eligible for Admission under PMSSS &nbsp;&nbsp;&nbsp;&nbsp;counselling process for the Academic year 2020-21.Selection wont be reverted back in any case.</font>
									</font>
								</b></h6>
		...
		<?php if ($own_row['applicationStatus'] == 'Seat Allocated - RC' || $own_row['applicationStatus'] == 'Seat Allocated') { ?>
			...
			<?php
				...
				<p align="center">
					<font color="red"><b><?php if ($own_row['title'] == 'HSC') { ?>Last Date for Joining College is 14-08-2019. Your Seat will be cancelled automatically if you are not joining.<?php
																																																		} else { ?>Last Date for Joining College is 14-08-2019. Your Seat will be cancelled automatically if you are not joining.<?php
																																																																																		} ?></b></font>
				</p><br>
			<?php
			} ?>
	...
	<?php
	if ($own_row['birthPlace'] == 'Yes' && $own_row['title'] == 'HSC') {
		if ($$own_row['yearOfCounselling'] == '2020-21') {
		...
		<div id="joiningDetails">
			...
			<?php if ((($user_row_x['joiningStatus'] != '' && $user_row_x['joiningStatus'] != null)
						&& $own_row['DBTApplicationStatus'] != 'New') || $user_row['finalCategory'] == 'Nursing'
					|| ($studentUniqueId == '2019162677' || $studentUniqueId == '2019007704' || $studentUniqueId == '2019294081')
				) { ?>
				<div class="col-lg-2">
					<a href="DBTinstruction.php" class="btn btn-success btn-block">Proceed for DBT</a>
				</div>
			<?php
				} else if ($own_row['applicationStatus'] == 'Seat Allocated - Own' && $user_row['category'] == 'Medical') { ?>
				<div class="col-lg-2">
					<a href="DBTinstruction.php" class="btn btn-success btn-block">Proceed for DBT</a>
				</div>
				<div class="col-lg-offset-1 col-lg-2">
			...
			<?php } else if ($own_row['applicationStatus'] == 'Seat Allocated - RC' && in_array($studentUniqueId, array(2019075970, 2019077423, 2019203967))) { ?>
				<div class="col-lg-2">
					<a href="DBTinstruction.php" class="btn btn-success btn-block">Proceed for DBT</a>
				</div>
			<?php
							...
							<div class="panel-body table-responsive">
								<table class="table table-bordered f11">
									...
									<tr>
										...
										<td align="left">
											<div class='input-group date' id='dateOfJoiningPicker' name="dateOfJoiningPicker"><input name="joiningDate" id="joiningDate" type='text' class="form-control" placeholder="Date of Joining" data-date-format="DD-MM-YYYY" data-date-minDate="1/1/1900"/ readonly>
	...
	<?php
		...
		$own_row['birthPlace'] == 'Yes' && $own_row['title'] == 'Diploma' && $user_row_x['joiningStatus'] != 'Accepted'
		&& $user_row['finalCategory'] != 'Nursing'
	) { ?>
		<div id="joiningDetails">
			<form id="joiningForm" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
				<div class="container-fluid">
			...
			<div class="modal-contentt" style="background-color:white">
				...
				<div class="modal-body">
					<div>Are you sure?<br><br>
						<b>I understand and accept, I would not be beneficiary of PMSSS for AY 2020-21 anymore.</b><br>
			...
			<div class="modal-contentt" style="background-color:white">
				...
				<div class="modal-body">
					<table class="table table-responsive table-bordered">
						...
						<?php
						$studQuery = "select name,studentRank,mobileNo,primaryEmailId,birthPlace,gender from students where yearOfCounselling='2020-21' and title='$title' and collegeUniqueId='$college' order by CAST(studentRank AS UNSIGNED) , studentRank";
						...
						while ($studRow = mysqli_fetch_assoc($studResult)) {
							...
							<tr>
								...
								<td><?php if ($studRow['birthPlace'] == 'Yes') echo 'Confirmed';
										else echo 'Not Yet Confirmed'; ?></td>
							</tr>
						<?php
						}
						mysqli_close($con); ?>
	...
	<script>
		...
		if ($('#dateOfJoiningPicker').length > 0) {
			...
			if (checking == 'Nursing') {
				$('#dateOfJoiningPicker').data("DateTimePicker").setMaxDate('30-11-2019');
			} else {
				$('#dateOfJoiningPicker').data("DateTimePicker").setMaxDate('15-09-2019');
			}
