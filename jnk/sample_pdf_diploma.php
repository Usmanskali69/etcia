    ...
    <table width="100%" style="text-align:center">
	  ...
	  <table width="100%" >
		  <tr>
			...
			<td  style="text-align:right" rowspan="8"><img src ="F://jk_media/'.$user_row['photo'].'"  style="height:90;width:100"></img></td>
		  </tr>
		  <tr>
