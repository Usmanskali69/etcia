<?php
	...
	/*$query = "SELECT 
			...
			WHERE
				...
				AND	s.streamAllottedIn = 'Medical'
	...
	if(mysqli_num_rows($result) != 0){
		$table = '	<br><br><h4><font color="#6D7B8D">Through Own Admission</font></h4><br>
		...
		echo '<h4 style="color: red;">No Student allotted in Medical Category</h4>';
	}
?>  