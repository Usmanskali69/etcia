			 ...
			 $joiningTag='<div class="panel panel-default">
						<div class="panel-body table-responsive">
							<table class="table table-bordered table-condensed f11">
								...
								<tr>
								<td width="15%" align="left"><input type="text" id="bankName" name="bankName" value="'.$user_row['bankName'].'"></td>
								</tr>-->';
								$joiningTag.='
								<tr>
								<td width="30%" align="left" ><font color="Red"><b>Bank Name: </b></font></td>
								...
								<tr>
								<td width="15%" align="left"><input type="text" id="bankAccountNumber" name="bankAccountNumber" value="'.$user_row['bankAccountNumber'].'"></td>
								</tr>
								<tr>
								<td width="30%" align="left" ><font color="Red"><b>Bank IFSC Code: </b></font></td>
								</tr>
								<tr>
								<td width="15%" align="left"><input type="text" id="bankifscCode" name="bankifscCode" value="'.$user_row['bankifscCode'].'"></td>
								</tr>
								<!--<tr>
								<td width="30%" align="left" ><font color="Red"><b>Bank MICR Code: </b></font></td>
								</tr>
								<tr>
								<td width="15%" align="left"><input type="text" id="bankmicrCode" name="bankmicrCode" value="'.$user_row['bankmicrCode'].'"></td>
								</tr>-->
								<tr>
								<td width="30%" align="left" ><font color="Red"><b>Bank Address: </b></font></td>
								</tr>
								<tr>
								<td width="15%" align="left"><input type="text" id="bankAddress" name="bankAddress" value="'.$user_row['bankAddress'].'"></td>
								</tr>
								<tr>
								<td width="30%" align="left" ><font color="Red"><b>Bank Branch Name: </b></font></td>
								</tr>
								<tr>
								<td width="15%" align="left"><input type="text" id="bankBranchName" name="bankBranchName" value="'.$user_row['bankBranchName'].'"></td>
								</tr>
								<tr>
								...
								<tr><td> <input type="radio" name="isFinanceApproved" id="isFinanceApproved" value="A" required="required"'; if($user_row['isFinanceApproved']=='A'){ $joiningTag.='checked';} $joiningTag.='> Accepted &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;							
...
echo '</div>
      ...
      <div class="modal-footer">
        <div class="col-md-8" id="verifyJoiningReportMessage" name="verifyJoiningReportMessage"></div>';       
		if(($user_row['isFinanceApproved']=='A' || $user_row['isFinanceApproved']=='N')&&($user_row['isAttachmentsSubmitted']=='Not Accepted' || $user_row['isAttachmentsSubmitted']=='Accepted')){
...
/* $("#UIDNo").keydown(function (e) {
 ...
 $('#verifyJoining').click(function(event) {
	...
	    			url: 'partials/data/students/aadharStudents.php'});
					...
					{
					$("#verifyJoiningReportMessage").html("<b><h4>Duplicate Aadhar Found - "+data+"</h4></b>").css("color", "#a94442");
					}					
                    setTimeout(function(){
				$("#verifyJoiningReportMessage").html('');
			...
			{
			$("#verifyJoiningReportMessage").html("<b><h4>Status/Comment/Bank Name is Mandatory</h4></b>").css("color", "#a94442");									
                    setTimeout(function(){
				$("#verifyJoiningReportMessage").html('');
