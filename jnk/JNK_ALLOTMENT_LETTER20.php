...
$query_x = 'SELECT wronglyAllottedStatus FROM students_x WHERE studentUniqueId="' . $studentUniqueId . '"';
$result_x = mysqli_query($con, $query_x);
$user_row_x = mysqli_fetch_array($result_x);
...
<body style="background-image: url(counsellor/img/bckimg.PNG); background-image-resize:10;background-repeat: no-repeat;background-position: center; " >
	<div style="border:1px solid black;padding:10px;"> <table width="100%" style="text-align:center">
         <tr>
            <td><img src ="counsellor/img/emblem.jpg" alt ="text" style="height:100;width:60"></img></td>
            <td><h3>';if($user_row_x['wronglyAllottedStatus']=='Yes'){
			$html .='<font color="red"><b>REVISED ALLOTMENT LETTER</b></font><br>';}$html .='ADMISSIONS UNDER PRIME MINISTER`S SPECIAL SCHOLARSHIP SCHEME<br>OF JAMMU & KASHMIR AND LADAKH STUDENTS ' . $yearOfCounselling . '</h3><h4 style="text-align:center"><br>ALL INDIA COUNCIL FOR TECHNICAL EDUCATION<br> VASANT KUNJ, NELSON MANDELA MARG, NEW DELHI-110070</h4>
			</td>
	  ...
	  <table width="100%" >
		  ...
		  <tr>
			 <td class="sub">Sub:</td>
			 <td class="sub"><b>Admission under Prime Minister’s Special Scholarship Scheme for the UTs of Jammu & Kashmir and Ladakh for Academic Year ' . $yearOfCounselling . '</b></td>
		  </tr>
	  </table>
  		<p class="endp" align="justify"><b>Dear Sir/Madam,</b><br><br>
			  ...
			  <br><br>
			  During the beginning of every academic year, AICTE conducts counseling for admission of eligible students under supernumerary quota created by the Government as per approved Scheme in various streams including General and Professional Under-Graduate Programmes in Colleges / Universities located outside the J&K and Ladakh. AICTE has conducted On-Line Counseling for admission to students under the Scheme purely on merit basis for admission to the eligible students. During the process, the following student has been allotted a seat in your college as per the given details:</p>
...
<br><br>
<p style="page-break-after:always;"></p>
<p style="font-size:9px;" align="justify">
This may be noted that the allotment letter is purely provisional subject to fulfillment of specific eligibility criteria for the course as prescribed by the affiliating University/ Institution and AICTE has no responsibility in this regard. The candidates should also note that some specific admission criteria have been fixed for Central universities and Centrally funded institutes e. g CUET is mandatory for admission under general stream and JEE and NEET are compulsory for admission in Engineering Stream and B.Sc. (Nursing) course respectively in GGS IP University.
<br><br>
The allotment and scholarship under the scheme is subject to verification of the candidate’s credential in National Scholarship Portal(NSP) for De-duplication process. 
	<br><br>
	Candidates who have been provisionally allotted the seat in any round of counseling are required to complete the Admission Formalities of the respective University/Institute on or before the last date mentioned in the calendar of events   positively.  The candidate should upload all the original documents on her/his portal and should be accepted by the Institute, failing which her/his candidature shall be cancelled automatically and the seat may be allotted to the next candidate in subsequent round of counseling.
	<br><br>
	The allotment letter in respect of the students who have been allotted seats (applicable to General Stream courses only) in Central Universities / Central Universities Affiliated College will remain valid till the start of admission process in these Institution Universities after declaration of CUET Results and subsequent counselling process.
	<br><br>
...
<ol type="1" class="">
	 <li>Maintenance Charges will be directly credited to the Candidates’ Aadhar Seeded Saving Bank Account through DBT, PFMS
mode in 9 installments / in a year. (This year it shall be proportional to the physical presence in the institute).</li>
...
charge will be paid to candidates directly. <b>For account detail beneficiary mandate form is available on</b> <a href="https://aicte-india.org/sites/default/files/pmsss2020/2022-23/BENEFICIARY%20MANDATE%20FORM.pdf" target="_blank">Mandate Form</a>.</li>
	 ...
	 <li>In case student is facing any internet issue in joining the allotted institution, she/he may contact the nearest Facilitation cum
Document Verification Centre of J&K and Ladakh for necessary help <a href="https://www.aicte-india.org/sites/default/files/pmsss2020/2022-23/ICT%202022-23.pdf" target="_blank">facilitation centres link</a> </li>
