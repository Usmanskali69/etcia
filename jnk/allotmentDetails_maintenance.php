...
<br class="hidden-lg">
<br class="hidden-lg">
<h2 style="margin-top:5px;font-size:20px;text-align:center" ><i class="fa fa-university fa-lg" aria-hidden="true"></i> PMSSS J&K Allotment Details
<br>
<br>
This page is under maintenance. Sorry for the inconvenience caused.</h2>
</body>
</html>  