			  ...
			  <div class="panel-heading">Pending Actions</div>
					<ul class="list-group  y-scroll">
					 ...
					 <?php if($user_row['isAttachmentsSubmitted'] != 'Accepted' && $year > 2014){?>
						<li class="list-group-item" style="color:#a94442;"><i class="fa fa-times"></i> Aadhar Verification By AICTE.</li>
					  <?php } ?>
					 <?php if($user_row['isFinanceApproved'] != 'Accepted' && $year > 2014){?>
						<li class="list-group-item" style="color:#a94442;"><i class="fa fa-times"></i> Bank Verification By AICTE.</li>
					 <?php } ?>
					 <?php 
			  ...
			  <div class="panel-heading">Completed Actions</div>
					<ul class="list-group  y-scroll">
					 ...
					 <?php if($user_row['DBTApplicationFormSubmitted'] == 'Y'){?>
					  ...
					  <?php } ?>
					 <?php if($user_row['isAttachmentsSubmitted'] == 'Accepted' && $year > 2014){?>
						<li class="list-group-item" style="color:#3c763d;"><i class="fa fa-check"></i> Aadhar Verification By AICTE.</li>
					  <?php } ?>
					 <?php if($user_row['isFinanceApproved'] == 'Accepted' && $year > 2014){?>
						<li class="list-group-item" style="color:#3c763d;"><i class="fa fa-check"></i> Bank Verification By AICTE.</li>
					 <?php } ?>
					 <?php 
						if($user_row['appliedFor'] > 1 && $user_row['approvedFor'] < $user_row['courseDuration']*2 && $user_row['title'] == 'HSC' && ($user_row['courseDuration'] != '' || $user_row['courseDuration'] != null)){
						$i = '';
