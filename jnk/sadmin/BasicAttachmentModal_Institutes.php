...
echo '<div class="modal-header">
		...
		{
			echo '<h4 class="modal-title" id="myModalLabel">Bank Details</h4>';
		}
		if($type=='mandateForm')
		{
			//echo $type;
		...
		{
			//echo $type;
			echo '<h4 class="modal-title" id="myModalLabel">Academic Fee Details</h4>';
		}
		if($type=='stateFee')
		{
			//echo $type;
			echo '<h4 class="modal-title" id="myModalLabel">Fee as per state fee regulatory </h4>';
		}
		
     echo'</div>
			<div class="modal-body">';
	
	$instituteQuery="SELECT $type FROM colleges_ext WHERE collegeUniqueId = '".$instituteId."'";
	//echo $instituteQuery;
