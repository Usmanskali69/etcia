...
<body style="background-image: url(counsellor/img/bckimg.PNG); background-image-resize:10;background-repeat: no-repeat;background-position: center; " >
    ...
    <table width="100%" style="text-align:center">
         <tr>
            ...
            <td><h3>ADMISSIONS UNDER PRIME MINISTER`S SPECIAL SCHOLARSHIP SCHEME<br>OF JAMMU & KASHMIR AND LADAKH '.$yearOfCounselling.'</h3><h4 style="text-align:center"><br>ALL INDIA COUNCIL FOR TECHNICAL EDUCATION,<br> VASANT KUNJ, NELSON MANDELA MARG,</h4><h5>NEW DELHI-110070</h5>
			</td>
	  ...
	  <table width="100%" >
		  ...
		  <tr>
			 <td class="sub">Sub:</td>
			 <td class="sub"><b>Admission of Jammu & Kashmir and Ladakh students in UG courses under PMSSS Academic Year '.$yearOfCounselling.'</b></td>
		  </tr>
	  </table>
...
This may be noted that the admission of the candidate is purely provisional and the same will be confirmed after the fulfillment of specific eligibility criteria for the course as prescribed by the affiliating University/ Institution and no responsibility will be taken by the AICTE.
	...
	<br><br>As a special consideration candidates are allowed to take on-line admission in the allotted college and will have to complete the online joining formalities immediately after giving confirmation of allotted seat as per prescribed rules available in her/his login.
		</p><br>
		<p>The institute may note that the academic fee of the candidate would be credited to the mandated bank account of the Institute by AICTE through PFMS as per the scheme guidelines (Please refer <link>) subject to commencement of the on-line classes. However, the Institute can collect only refundable deposits/ caution money (if any). Hostel/ Mess charges shall be collected from the candidates only after students physically join the institute. Maintenance Allowance of Rs.1.00 lakh per annum will be paid to the student in Nine (9) instalments to bear expenses towards hostel /mess /books & stationary etc. First instalment of which Rs. 20,000/- will be released immediately on verification of physical joining report by the Institute. Remaining Eight (8) instalments of Rs.10, 000/- each will be released on monthly basis subject to online verification of student’s attendance by the concerned Institute. Institutes are directed to collect only monthly charges from students as mess and hostel charges.</p>
		<br>
...
<ol type="1" class="endl">
	 <li><b>Maintenance Charges</b> will be directly credited to the Candidates’ Aadhar Saving Account through DBT, PFMS mode in 9 installments / in a year.(This year it shall be proportional to the physical presence in the institute).</li>
	 ...
	 <li>In case of any query, candidate or head of the institutions may call the helpline number at 011-29581043/011-29581007 (Timings 9:30 hrs to 17:00 hrs Monday-Friday) or may raise the query from their login.</li>
	 ...
	 <li>After confirmation of allotted seat, the student is required to contact Principal/ Nodal Officer of the Institution for completion of on-line admission form.	</li>
</ol>
