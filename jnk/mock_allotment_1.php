...
<body>
 	...
 	<h3 class="container" align="center">
		List of Colleges and Courses Filled by PMSSS 2017-18 Students (Round 1)	
				
        </h3>
		
	<div class="container-fluid" id="tableContent">
	
	<table id="colleges" data-height="550" data-toggle="table" data-url="operations/showMockAllotment1.php" data-pagination="true" data-search="true" data-sort-name="Submitted" data-sort-order="asc" data-show-refresh="true" >
	
		<thead class="btn-primary" >
			
						<th data-field="studentUniqueId" data-sortable="true">Student Id</th>
						<th data-field="studentName">Name</th>
						<th data-field="collegeUniqueId" data-sortable="true">College Id</th>					
						<!--<th data-field="collegeName" data-sortable="true">College Name</th>		-->					
						<th data-field="courseUniqueId">Course Id</th>
