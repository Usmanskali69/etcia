		...
		<div class="container" style="margin-top: 30px; margin-bottom: 20px;">
			...
			<div id="formDiv">
				<?php
					...
					include("./partials/forms/emailPreviousYearStudentDetailsImc.php");
				?>					
			</div>
				...
				$('#submitMailButton').click(function(event) {
					...
					if($("#sendEmailForm").valid()){
						...
						$.ajax({
							...
							url         : 'partials/mail/PreviousYearMailImc.php', // the url where we want to POST
