...
echo '</div>
      ...
      <div class="modal-footer">
		...
		<button type="button" class="btn btn-success" style="width:100px;" id="verifyJoining" name="verifyJoining"';if($user_row_x['joiningStatus']=='Accepted'){echo 'disabled';} echo '>Confirm</button>
