<?php
	...
	$query="SELECT name,studentUniqueId,applicationStatus,yearOfCounselling FROM students WHERE studentUniqueId=?";	
...
<html lang="en">
	...
	<body>
        ...
        <div class="tab-content">
			...
			<h3><center><b><?php if($user_row['applicationStatus']=='Submitted and Verified - RC') { ?>You have opted for next round of counselling. You can fill fresh choices based on the vacant seats available from first round of counseling from 23rd June Onwards. <?php } else if($user_row['applicationStatus']=='Not Interested in PMSSS') {?> Dear <?php echo $user_row['name'].'('.$user_row['studentUniqueId'].')';?>,<br><br>

We are thankful to you for registering your interest for Prime Ministers' Special Scholarship Scheme (PMSSS) for AY 2019-20.However,you have opted out from the scheme from your own interest.All the best for your bright future. <?php } ?></h3></center></b>
			<br/>			
			<br/>
			</div>
        </div>
